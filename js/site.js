...
function generate3W(data, geom) {
 ...
 where.width($('#map').width())
            ...
            .featureKeyAccessor(function(feature){
                return feature.properties['ADM3_PCODE'];
...
var geodataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'data/moz-adm3.geojson',
});

var dataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F1ane7zXKWcKTwy4nKLD96BTL39QwX6zqjFoAI-o7D2N8%2Fedit%3Fusp%3Dsharing&force=on'
});

var dateCall = $.ajax({
    type: 'GET',
    dataType : 'JSON',
    url : 'https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F13B-nk4TFOyA5cw3kgkxUIynXcWD2KAEDqx54CjxhkEs%2Fedit%23gid%3D2048099003&force=on',
});
